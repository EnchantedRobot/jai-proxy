"""proxy/media_names.py must match its JS counterparts exactly -- see the
...
FIXTURE = Path(__file__).parent / "fixtures" / "media_3c" / "real_url_names.json"

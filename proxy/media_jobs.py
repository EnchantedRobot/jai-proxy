...
from proxy import media_manifest, media_writer, thumbs
from proxy.config import settings

logger = logging.getLogger("jai_proxy.media_jobs")
...
class JobStore:
    ...
    see the module docstring in `proxy/api/v1.py`) and hands the item list
